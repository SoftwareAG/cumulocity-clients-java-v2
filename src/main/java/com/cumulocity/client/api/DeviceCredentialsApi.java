...
public class DeviceCredentialsApi extends AdaptableApi {
	 ...
	 * <ul>
	 * <li>200 Device credentials were created.</li>
	 ...
	 * @return
	 */
	public Future<DeviceCredentials> createDeviceCredentials(final DeviceCredentials body, final String xCumulocityProcessingMode) {
	 ...
	 * <br>The following table gives an overview of the possible response codes and their meanings:</br>
	 * <ul>
	 * <li>201 A bulk of new device requests was created.</li>
	 * <li>401 Authentication information is missing or invalid.</li>
	 * </ul>
	 * <p>

...
public class UsersApi extends AdaptableApi {
	 ...
	 * @return
	 */
	public Future<User> createUser(final User body, final String tenantId, final String xCumulocityProcessingMode) {
	 ...
	 * @return
	 */
	public Future<User> updateUser(final User body, final String tenantId, final String userId, final String xCumulocityProcessingMode) {
		final JsonNode jsonNode = toJsonNode(body);
		removeFromNode(jsonNode, "passwordStrength");
		removeFromNode(jsonNode, "roles");
		removeFromNode(jsonNode, "groups");
	 ...
	 * @param xCumulocityProcessingMode Used to explicitly control the processing mode of the request. See [Processing mode](#processing-mode) for more details.
	 */
	public Future<Response> deleteUser(final String tenantId, final String userId, final String xCumulocityProcessingMode) {
		return getRootTarget().path("user").path(valueOf(tenantId)).path("users").path(valueOf(userId))
				.request()
				.header("X-Cumulocity-Processing-Mode", xCumulocityProcessingMode)
	 ...
	 * @param xCumulocityProcessingMode Used to explicitly control the processing mode of the request. See [Processing mode](#processing-mode) for more details.
	 */
	public Future<Response> updateUserPassword(final PasswordChange body, final String tenantId, final String userId, final String xCumulocityProcessingMode) {
		final JsonNode jsonNode = toJsonNode(body);
	 ...
	 * @return
	 */
	public Future<UserReference> assignUserToUserGroup(final SubscribedUser body, final String tenantId, final int groupId, final String xCumulocityProcessingMode) {
		final JsonNode jsonNode = toJsonNode(body);
		return getRootTarget().path("user").path(valueOf(tenantId)).path("groups").path(valueOf(groupId)).path("users")
				.request()
				.header("X-Cumulocity-Processing-Mode", xCumulocityProcessingMode)
	 ...
	 * @param xCumulocityProcessingMode Used to explicitly control the processing mode of the request. See [Processing mode](#processing-mode) for more details.
	 */
	public Future<Response> removeUserFromUserGroup(final String tenantId, final int groupId, final String userId, final String xCumulocityProcessingMode) {

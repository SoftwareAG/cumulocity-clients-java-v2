...
public class AlarmCollection {
	...
	/**
	 * <p>An array containing the results (alarms) of the request.</p>
	 */
	...
	public boolean equals(final Object r) {
		if (r != null && r instanceof AlarmCollection) {
			AlarmCollection comparer = (AlarmCollection) r;
			if (comparer.getAlarms().equals(this.getAlarms()) && String.valueOf(comparer.getNext()).equals(String.valueOf(this.getNext())) && String.valueOf(comparer.getPrev()).equals(String.valueOf(this.getPrev())) && String.valueOf(comparer.getSelf()).equals(String.valueOf(this.getSelf())) && comparer.getStatistics().equals(this.getStatistics())) {
				return true;
			}
		}
		return false;

...
public class ApplicationCollection {
	...
	public boolean equals(final Object r) {
		if (r != null && r instanceof ApplicationCollection) {
			ApplicationCollection comparer = (ApplicationCollection) r;
			if (comparer.getApplications().equals(this.getApplications()) && String.valueOf(comparer.getNext()).equals(String.valueOf(this.getNext())) && String.valueOf(comparer.getPrev()).equals(String.valueOf(this.getPrev())) && String.valueOf(comparer.getSelf()).equals(String.valueOf(this.getSelf())) && comparer.getStatistics().equals(this.getStatistics())) {
				return true;
			}
		}
		return false;

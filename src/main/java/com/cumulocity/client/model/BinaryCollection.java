...
public class BinaryCollection {
	...
	public Binary[] getManagedObjects() {
		return managedObjects;
	}
	
	public void setManagedObjects(final Binary[] managedObjects) {
	...
	public boolean equals(final Object r) {
		if (r != null && r instanceof BinaryCollection) {
			BinaryCollection comparer = (BinaryCollection) r;
			if (comparer.getManagedObjects().equals(this.getManagedObjects()) && String.valueOf(comparer.getNext()).equals(String.valueOf(this.getNext())) && String.valueOf(comparer.getPrev()).equals(String.valueOf(this.getPrev())) && String.valueOf(comparer.getSelf()).equals(String.valueOf(this.getSelf())) && comparer.getStatistics().equals(this.getStatistics())) {
				return true;
			}
		}
		return false;

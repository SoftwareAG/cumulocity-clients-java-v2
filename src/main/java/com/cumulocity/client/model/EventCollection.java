...
public class EventCollection {
	...
	/**
	 * <p>An array containing the results (events) of the request.</p>
	 */
	...
	public boolean equals(final Object r) {
		if (r != null && r instanceof EventCollection) {
			EventCollection comparer = (EventCollection) r;
			if (comparer.getEvents().equals(this.getEvents()) && String.valueOf(comparer.getNext()).equals(String.valueOf(this.getNext())) && String.valueOf(comparer.getPrev()).equals(String.valueOf(this.getPrev())) && String.valueOf(comparer.getSelf()).equals(String.valueOf(this.getSelf())) && comparer.getStatistics().equals(this.getStatistics())) {
				return true;
			}
		}
		return false;

...
public class GroupReferenceCollection {
	...
	/**
	 * <p>An array of group references.</p>
	 */
	...
	public boolean equals(final Object r) {
		if (r != null && r instanceof GroupReferenceCollection) {
			GroupReferenceCollection comparer = (GroupReferenceCollection) r;
			if (String.valueOf(comparer.getSelf()).equals(String.valueOf(this.getSelf())) && comparer.getReferences().equals(this.getReferences()) && String.valueOf(comparer.getPrev()).equals(String.valueOf(this.getPrev())) && String.valueOf(comparer.getNext()).equals(String.valueOf(this.getNext())) && comparer.getStatistics().equals(this.getStatistics())) {
				return true;
			}
		}
		return false;

...
public class ManagedObjectCollection {
	...
	public void setManagedObjects(final ManagedObject[] managedObjects) {
	...
	public boolean equals(final Object r) {
		if (r != null && r instanceof ManagedObjectCollection) {
			ManagedObjectCollection comparer = (ManagedObjectCollection) r;

...
public class MeasurementCollection {
	...
	/**
	 * <p>An array containing the measurements of the request.</p>
	 */
	...
	public MeasurementCollection(final Measurement[] measurements) {
	...
	public boolean equals(final Object r) {
		if (r != null && r instanceof MeasurementCollection) {
			MeasurementCollection comparer = (MeasurementCollection) r;
			if (comparer.getMeasurements().equals(this.getMeasurements()) && String.valueOf(comparer.getNext()).equals(String.valueOf(this.getNext())) && String.valueOf(comparer.getPrev()).equals(String.valueOf(this.getPrev())) && String.valueOf(comparer.getSelf()).equals(String.valueOf(this.getSelf())) && comparer.getStatistics().equals(this.getStatistics())) {
				return true;
			}
		}
		return false;

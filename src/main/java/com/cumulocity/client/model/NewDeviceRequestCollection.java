...
public class NewDeviceRequestCollection {
	...
	/**
	 * <p>An array of new device requests.</p>
	 */
	private NewDeviceRequest[] newDeviceRequests;
	...
	public void setNewDeviceRequests(final NewDeviceRequest[] newDeviceRequests) {
	...
	public boolean equals(final Object r) {
		if (r != null && r instanceof NewDeviceRequestCollection) {
			NewDeviceRequestCollection comparer = (NewDeviceRequestCollection) r;
			if (comparer.getNewDeviceRequests().equals(this.getNewDeviceRequests()) && String.valueOf(comparer.getNext()).equals(String.valueOf(this.getNext())) && String.valueOf(comparer.getPrev()).equals(String.valueOf(this.getPrev())) && String.valueOf(comparer.getSelf()).equals(String.valueOf(this.getSelf())) && comparer.getStatistics().equals(this.getStatistics())) {
				return true;
			}
		}
		return false;

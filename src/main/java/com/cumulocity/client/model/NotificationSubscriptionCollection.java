...
public class NotificationSubscriptionCollection {
	...
	/**
	 * <p>An array containing the subscriptions of the request.</p>
	 */
	...
	public boolean equals(final Object r) {
		if (r != null && r instanceof NotificationSubscriptionCollection) {
			NotificationSubscriptionCollection comparer = (NotificationSubscriptionCollection) r;
			if (String.valueOf(comparer.getNext()).equals(String.valueOf(this.getNext())) && String.valueOf(comparer.getPrev()).equals(String.valueOf(this.getPrev())) && String.valueOf(comparer.getSelf()).equals(String.valueOf(this.getSelf())) && comparer.getStatistics().equals(this.getStatistics()) && comparer.getSubscriptions().equals(this.getSubscriptions())) {
				return true;
			}
		}
		return false;

...
public class OperationCollection {
	...
	public boolean equals(final Object r) {
		if (r != null && r instanceof OperationCollection) {
			OperationCollection comparer = (OperationCollection) r;
			if (String.valueOf(comparer.getNext()).equals(String.valueOf(this.getNext())) && comparer.getOperations().equals(this.getOperations()) && String.valueOf(comparer.getPrev()).equals(String.valueOf(this.getPrev())) && String.valueOf(comparer.getSelf()).equals(String.valueOf(this.getSelf())) && comparer.getStatistics().equals(this.getStatistics())) {
				return true;
			}
		}
		return false;

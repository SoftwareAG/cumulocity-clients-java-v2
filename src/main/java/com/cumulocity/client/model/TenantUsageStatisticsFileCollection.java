...
public class TenantUsageStatisticsFileCollection {
	...
	public StatisticsFile[] getStatisticsFiles() {
		return statisticsFiles;
	}
	
	public void setStatisticsFiles(final StatisticsFile[] statisticsFiles) {
	...
	public boolean equals(final Object r) {
		if (r != null && r instanceof TenantUsageStatisticsFileCollection) {
			TenantUsageStatisticsFileCollection comparer = (TenantUsageStatisticsFileCollection) r;
			if (String.valueOf(comparer.getNext()).equals(String.valueOf(this.getNext())) && String.valueOf(comparer.getPrev()).equals(String.valueOf(this.getPrev())) && String.valueOf(comparer.getSelf()).equals(String.valueOf(this.getSelf())) && comparer.getStatistics().equals(this.getStatistics()) && comparer.getStatisticsFiles().equals(this.getStatisticsFiles())) {
				return true;
			}
		}
		return false;

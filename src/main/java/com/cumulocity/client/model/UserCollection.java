...
public class UserCollection {
	...
	public boolean equals(final Object r) {
		if (r != null && r instanceof UserCollection) {
			UserCollection comparer = (UserCollection) r;
			if (String.valueOf(comparer.getNext()).equals(String.valueOf(this.getNext())) && String.valueOf(comparer.getPrev()).equals(String.valueOf(this.getPrev())) && String.valueOf(comparer.getSelf()).equals(String.valueOf(this.getSelf())) && comparer.getStatistics().equals(this.getStatistics()) && comparer.getUsers().equals(this.getUsers())) {
				return true;
			}
		}
		return false;
